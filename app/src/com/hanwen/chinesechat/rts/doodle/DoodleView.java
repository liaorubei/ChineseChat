package com.hanwen.chinesechat.rts.doodle;
...
import com.hanwen.chinesechat.rts.doodle.action.Action;
        ...
        for (Transaction t : transactions) {
            switch (t.getStep()) {
                case Transaction.ActionStep.START:
                    ...
                    playbackChannel.action = new MyPath(t.getX() * zoom, t.getY() * zoom, playbackChannel.paintColor, playbackChannel.paintSize);
