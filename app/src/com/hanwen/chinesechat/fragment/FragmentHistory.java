 ...
 * interface.
 */
public class FragmentHistory extends Fragment implements SwipeRefreshLayout.OnRefreshListener, XListView.IXListViewListener {
    ...
    public static FragmentHistory newInstance(Calendar calendar) {
