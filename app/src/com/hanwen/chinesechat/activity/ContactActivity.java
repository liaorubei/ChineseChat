...
import com.hanwen.chinesechat.bean.Answer;
import com.hanwen.chinesechat.bean.Answer.People;
...
public class ContactActivity extends Activity implements OnClickListener {
    ...
    private class MyAdapter extends BaseAdapter<People> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            TextView textView =new TextView(getApplicationContext());// (TextView) View.inflate(ContactActivity.this, R.layout.listitem_listactivity, null);
