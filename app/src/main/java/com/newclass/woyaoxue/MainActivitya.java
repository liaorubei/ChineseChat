...
public class MainActivitya extends FragmentActivity implements OnClickListener {
    // Monkey测试代码
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            release ="student"; getPackageManager().getApplicationInfo(getPackageName(), PackageManager.GET_META_DATA).metaData.getString("release");
