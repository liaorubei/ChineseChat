...
public class SlideView extends LinearLayout {
    ...
    private static final String TAG = "com.newclass.woyaoxue.SlideView";
    ...
    public interface OnSlideListener {
        ...
        /**
         * @param view   current com.newclass.woyaoxue.SlideView
    ...
    public void onRequireTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN: {
                downX = event.getX();
                //   Log.i(TAG, "ACTION_DOWN downX=" + downX);
            ...
            case MotionEvent.ACTION_MOVE: {
                Log.i(TAG, "ACTION newScrollX=" + event.getX());
                moveX = (int) getX();
